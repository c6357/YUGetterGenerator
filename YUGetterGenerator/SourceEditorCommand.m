...
#define ReturnGetter(clsName) if ([className isEqualToString:[NSString stringWithUTF8String:#clsName]]) return clsName##Getter(propertyName);
    ...
    ReturnGetter(NSArray)
    ReturnGetter(NSMutableArray)
    ReturnGetter(NSDictionary)
    ReturnGetter(NSMutableDictionary)
...
static inline NSArray *NSArrayGetter(NSString *propertyName) {
    
    NSString *className = @"NSArray";
    GetterBeginWithoutInit
    AddLine(@"       _%@ = [NSArray new];",propertyName)
    GetterEnd
}

static inline NSArray *NSMutableArrayGetter(NSString *propertyName) {
    
    NSString *className = @"NSMutableArray";
    GetterBeginWithoutInit
    AddLine(@"       _%@ = [NSMutableArray new];",propertyName)
    GetterEnd
}

static inline NSArray *NSDictionaryGetter(NSString *propertyName) {
    
    NSString *className = @"NSDictionary";
    GetterBeginWithoutInit
    AddLine(@"       _%@ = [NSDictionary new];",propertyName)
    GetterEnd
}

static inline NSArray *NSMutableDictionaryGetter(NSString *propertyName) {
    
    NSString *className = @"NSMutableDictionary";
    GetterBeginWithoutInit
    AddLine(@"       _%@ = [NSMutableDictionary new];",propertyName)
    GetterEnd
}
